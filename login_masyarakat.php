...
<head>
    ...
    .image-section {
        background-image: url(daunlogin.png);
    ...
    <div class="container">
        <div class="row form-wrapper">
            ...
            <div class="col-md-6 form-section">
                ...
                <h3 class="text-success mb-4 text-center mt-5">Login Masyarakat</h3>
                ...
                <form method="POST">
                    ...
                    <p class="mt-3 text-center">Belum punya akun? <a href="register_masyarakat.php"
                            class="text-success">Register</a></p>
                    <p class="mt-2 text-center">
                        <a href="login_petugas.php" class="btn btn-outline-success w-100">Login sebagai
                            Petugas</a>
                    </p>
                </form>
            </div>
